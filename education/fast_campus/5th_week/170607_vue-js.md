...
---
<!-- footer : Vue.js - 프론트엔드 개발자를 위한 웹앱 프로젝트 CAMP -->
## Vue 는 무엇인가?
...
> 실습! 한번 Vue.js 로 Hello World 를 찍어보겠습니다.
...
[Nested View vs Named View](위를 비교하는 간단한 그림 keynote 로 제작)
...
**참고 : ES5 를 사용하는 경우 single file component 의 혜택을 볼 수 없음**
