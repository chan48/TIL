...
2. `DNS Lookup` : 사이트 주소에 해당되는 Server IP 를 접근한다. (DNS - Domain Name System 이용)
3. `Socket Connection` : Client (브라우저) 와 Server 간 접속을 위한 TCP 소켓 연결. (TCP - Transmission Control Protocol)
...
[아랫말 주석 가능한지 확인 해서 DNS, TCP 아래로 내리기]
...
![fp-pp-loading 40%](/Users/gihyojoshuajang/Documents/Programming/TIL/education/fast_campus/1st_week/fp-pp-loading.png)
...
![cs-rendering-vs-ss-rendering 40%](/Users/gihyojoshuajang/Documents/Programming/TIL/education/fast_campus/1st_week/rendering-difference.png)
...
![mvc-fw](/Users/gihyojoshuajang/Documents/Programming/TIL/education/fast_campus/1st_week/mvc-fw.jpeg)
