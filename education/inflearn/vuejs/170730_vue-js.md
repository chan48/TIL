...
---
<!-- footer : Vue.js 시작하기 ⓒCaptain Pangyo All Rights Reserved -->
## 개요
...
---
#### Props
- **상위 컴포넌트에서 하위 컴포넌트로 전달할 때 사용하는 속성**
- 왜 사용해야 하나? 모든 컴포넌트는 각 컴포넌트 자체의 스코프를 갖는다.
...
---
#### Class Binding
- CSS 스타일링을 위해서 class 를 아래와 같이 추가할 수 있다.
