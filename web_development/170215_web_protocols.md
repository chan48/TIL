...
- 위 URL 은 http 프로토콜을 이용하고, www.netbook.cs.purdue.edu 의 이름을 갖는 컴퓨터에서 toc/toc01.htm 파일을 접근한다.
...
- GET 요청을 받은 서버에서는 헤더, 빈 줄, 요청한 문서를 클라이언트로 보낸다.
...
- 흔한 상태 정보로는 404 (해당 문서 못 찾음), 200 (요청 처리 완료) 등이 있다.
